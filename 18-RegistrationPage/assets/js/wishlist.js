import { getDataFromLocal, setDataInLocal } from "./localstoragehelpers.js";
...
const createCard = (arr) => {
  arr.forEach((id) => {
    ...
    productDesc.textContent = `${card.description.slice(0, 100)}...`;
    ...
    heartBtn.addEventListener("click", () => {
      const findIdx = activeUser.wishlist.findIndex((p) => p == card.id);
