...
const cardMain = document.querySelector(".bestSellerCardsMain");

const favs = getDataFromLocal("favs") || [];
const basket=getDataFromLocal("basket") || []

const prevBtn = document.querySelector(".seller-prev-btn");
const nextBtn = document.querySelector(".seller-next-btn");

function createBestSellerCard(arr) {
  arr.forEach((elem) => {
