    ...
    <div className="relative bg-[#242424] min-h-screen">
      ...
      <div className="max-w-[1480px]">
        <div className="px-10 text-white">
          <h1 className="text-4xl md:text-6xl font-semibold md:w-[40%] py-10">
            Everyone has a story to tell
          </h1>
          <p className="md:w-[50%] text-xl py-10">
          ...
          <p className=" md:w-[40%] text-2xl leading-relaxed relative text-white py-5">
          ...
          <p className="md:w-[50%] text-xl py-5">
          ...
          <p className="md:w-[50%] text-xl py-5 mb-20">
